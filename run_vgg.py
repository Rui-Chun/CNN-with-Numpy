...
class MyNet():
    ...
    def save_model(self, model_path):
        ...
        self.layers[-2].gradient_in = None
        self.layers[-2].gradient_weight = None
        self.layers[-2].gradient_bias = None
        self.layers[-3].gradient_in = None
        self.layers[-3].gradient_weight = None
        self.layers[-3].gradient_bias = None
