...
class MyNet():
    ...
    def make_layers(self):
        ...
        self.layers.append(Linear(3*3*128, 256))
        self.layers.append(Relu())
        self.layers.append(Linear(256, 2))
...
Load_Model =  False
dataset_path = './LFW/'
model_path = './new2_best_model.pkl'
model_save_path = './new2_model_best.pkl'
model_temp_path = './new2_model_temp.pkl'
